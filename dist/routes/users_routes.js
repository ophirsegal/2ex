...
router.put("/:id", auth_controller_1.authMiddleware, (req, res) => {
    users_controller_1.default.updatePasswordById(req, res);
});
/**
 * @swagger
 * /users/{id}:
 ...
 */
router.put("/:id", auth_controller_1.authMiddleware, (req, res) => {
    users_controller_1.default.updateFavPatById(req, res);
});
/**
 * @swagger
 * /users/{id}:
...
router.delete("/:id", auth_controller_1.authMiddleware, (req, res) => {
    users_controller_1.default.deleteUserById(req, res);
});
